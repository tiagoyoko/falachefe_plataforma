...
CREATE TYPE "public"."message_type" AS ENUM('text', 'image', 'document', 'template', 'interactive', 'flow');--> statement-breakpoint
...
ALTER TABLE "admin_users" ADD CONSTRAINT "admin_users_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
