 ...
 * usando o banco de dados real com Drizzle
 */
...
async function testAgentWithDatabase() {
  console.log('🧪 Testando agente com banco de dados real...\n')
  ...
  try {
    ...
    // 5. Testar agente com mensagem que deveria consultar perfil
    ...
    try {
      // Nota: Implementar método de limpeza se necessário
      console.log('✅ Dados de teste mantidos para futuras verificações')
    } catch (error) {
